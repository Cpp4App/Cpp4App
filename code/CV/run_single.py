...
if __name__ == '__main__':
    ...
    key_params = {'min-grad': 4, 'ffl-block': 5, 'min-ele-area': 50,
                  'merge-contained-ele': True, 'merge-line-to-paragraph': False, 'remove-top-bar': False, 'remove-bottom-bar': False}

    # set input image path
    # input_path_img = 'data/input/497.jpg'
    # output_root = 'data/output'
    input_path_img = 'C:/ANU/2022 s2/honours project/dataset/new/original screenshots/3-2.jpg'
    output_root = 'data_test_rule/output'
    ...
    if is_merge:
        ...
        merge.merge(input_path_img, compo_path, ocr_path, pjoin(output_root, 'merge'),
                    is_remove_top_bar=key_params['remove-top-bar'], is_remove_bottom_bar=key_params['remove-bottom-bar'], is_paragraph=key_params['merge-line-to-paragraph'], show=True)
